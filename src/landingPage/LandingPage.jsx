    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
      <header className="p-6 flex items-center justify-between">
        ...
        <div className="space-x-4">
          ...
          <Link
            to="/signup"
            className="px-4 py-2 bg-blue-600 border border-white font-semibold rounded hover:bg-white hover:text-blue-600 transition"
          >
            Sign Up
          </Link>
        </div>
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-16 md:px-12">
        ...
        <p className="text-lg md:text-xl mb-8">
          A place where you can manage and explore your interests, connect with
          others, and more!
        </p>
        <div className="space-x-4">
          <Link
          ...
          <Link
            to="/about"
            className="px-6 py-3 bg-blue-600 border border-white font-semibold rounded-lg hover:bg-white hover:text-blue-600 transition"
          >
            Learn More
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Easily sign up, log in, and manage your profile seamlessly with
                our user-friendly authentication system.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Explore and engage with user content, and update your profile
                with cool features.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Save your data safely and securely with integrated cloud
                storage.
              </p>
            </div>
          </div>
